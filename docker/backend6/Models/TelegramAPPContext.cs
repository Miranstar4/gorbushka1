...
namespace backend6.Models
{
    public partial class TelegramAPPContext : DbContext
    {
        ...
        public virtual DbSet<ProductTop> ProductTops { get; set; } = null!;
        public virtual DbSet<ProductType> ProductTypes { get; set; } = null!;
        public virtual DbSet<Promocode> Promocodes { get; set; } = null!;
        public virtual DbSet<PromocodeSubcategory> PromocodeSubcategories { get; set; } = null!;
        public virtual DbSet<PromocodeUserActive> PromocodeUserActives { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<GameUser>(entity =>
            {
                ...
                entity.Property(e => e.DateLastGame)
                    .HasColumnType("date")
                    .HasColumnName("dateLastGame");
            ...
            modelBuilder.Entity<Order>(entity =>
            {
                ...
                entity.HasOne(d => d.PromocodeNavigation)
                    ...
                    .HasConstraintName("FK_Order_To_Promocode");
            ...
            modelBuilder.Entity<Post>(entity =>
            {
                ...
                entity.HasOne(d => d.AdminNavigation)
                    .WithMany(p => p.Posts)
                    .HasForeignKey(d => d.Admin)
                    .HasConstraintName("FK_Post_To_Admin");
            });
            ...
            modelBuilder.Entity<ProductTop>(entity =>
            {
                ...
                entity.HasOne(d => d.ProductNavigation)
                    .WithMany(p => p.ProductTops)
                    .HasForeignKey(d => d.Product)
                    .HasConstraintName("FK_ProductTop_To_Product");
            });
            ...
            modelBuilder.Entity<Promocode>(entity =>
            {
                ...
                entity.Property(e => e.BonusMoney).HasColumnName("bonusMoney");

                entity.Property(e => e.BonusProcent).HasColumnName("bonusProcent");
                ...
                entity.Property(e => e.PriceСondition).HasColumnName("priceСondition");

                entity.Property(e => e.SuccessMessage).HasColumnName("successMessage");

                entity.Property(e => e.Type).HasColumnName("type");

                entity.Property(e => e.UserActivePromocode).HasColumnName("userActivePromocode");

                entity.HasOne(d => d.UserActivePromocodeNavigation)
                    .WithMany(p => p.Promocodes)
                    .HasForeignKey(d => d.UserActivePromocode)
                    .HasConstraintName("FK_Promocode_To_User");
            });

            modelBuilder.Entity<PromocodeSubcategory>(entity =>
            {
                entity.ToTable("PromocodeSubcategory");
                ...
                entity.HasOne(d => d.PromocodeNavigation)
                    .WithMany(p => p.PromocodeSubcategories)
                    .HasForeignKey(d => d.Promocode)
                    .HasConstraintName("FK_PromocodeSubcategory_To_Promocode");

                entity.HasOne(d => d.SubcategoryNavigation)
                    .WithMany(p => p.PromocodeSubcategories)
                    .HasForeignKey(d => d.Subcategory)
                    .HasConstraintName("FK_PromocodeSubcategory_To_Subcategory");
            });

            modelBuilder.Entity<PromocodeUserActive>(entity =>
            {
                entity.ToTable("PromocodeUserActive");
                ...
                entity.HasOne(d => d.PromocodeNavigation)
                    .WithMany(p => p.PromocodeUserActives)
                    .HasForeignKey(d => d.Promocode)
                    .HasConstraintName("FK_PromocodeUserActive_To_Promocode");

                entity.HasOne(d => d.UserNavigation)
                    .WithMany(p => p.PromocodeUserActives)
                    .HasForeignKey(d => d.User)
                    .HasConstraintName("FK_PromocodeUserActive_To_User");
            });
